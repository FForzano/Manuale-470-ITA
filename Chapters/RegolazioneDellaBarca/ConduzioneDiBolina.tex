...
\section{Conduzione di Bolina}
\label{sec:ConduzioneDiBolina}
...
\subsection{Il prodiere}
\label{subsec:IlProdiere}
...
\subsection{Il timoniere}
\label{subsec:IlTimoniere}
...
\subsection{La virata}
\label{subsec:LaVirata}
...
\subsection{Regolazione delle vele}
\label{subsec:RegolazioneDelleVele}
...
Considera che il vento spesso non è stabile per più di un paio di secondi alla
...
Quattro coppie di \telltales facilitano la regolazione del fiocco. Tre coppie
